...
func (n *Node) discoverCluster() error {
	...
	config.MaxRetries = 5                    // Enough retries to survive view change delays
	config.Timeout = 3 * time.Second         // Per-attempt timeout
	config.RetryDelay = 2 * time.Second      // Delay between retries
